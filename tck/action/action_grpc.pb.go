...
func (c *actionTckModelClient) ProcessUnary(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/akkaserverless.tck.model.action.ActionTckModel/ProcessUnary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *actionTckModelClient) ProcessStreamedIn(ctx context.Context, opts ...grpc.CallOption) (ActionTckModel_ProcessStreamedInClient, error) {
	stream, err := c.cc.NewStream(ctx, &ActionTckModel_ServiceDesc.Streams[0], "/akkaserverless.tck.model.action.ActionTckModel/ProcessStreamedIn", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *actionTckModelClient) ProcessStreamedOut(ctx context.Context, in *Request, opts ...grpc.CallOption) (ActionTckModel_ProcessStreamedOutClient, error) {
	stream, err := c.cc.NewStream(ctx, &ActionTckModel_ServiceDesc.Streams[1], "/akkaserverless.tck.model.action.ActionTckModel/ProcessStreamedOut", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *actionTckModelClient) ProcessStreamed(ctx context.Context, opts ...grpc.CallOption) (ActionTckModel_ProcessStreamedClient, error) {
	stream, err := c.cc.NewStream(ctx, &ActionTckModel_ServiceDesc.Streams[2], "/akkaserverless.tck.model.action.ActionTckModel/ProcessStreamed", opts...)
	if err != nil {
		return nil, err
	}
...
func RegisterActionTckModelServer(s grpc.ServiceRegistrar, srv ActionTckModelServer) {
	s.RegisterService(&ActionTckModel_ServiceDesc, srv)
}
...
func _ActionTckModel_ProcessUnary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/akkaserverless.tck.model.action.ActionTckModel/ProcessUnary",
	}
...
// ActionTckModel_ServiceDesc is the grpc.ServiceDesc for ActionTckModel service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ActionTckModel_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "akkaserverless.tck.model.action.ActionTckModel",
...
func (c *actionTwoClient) Call(ctx context.Context, in *OtherRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/akkaserverless.tck.model.action.ActionTwo/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterActionTwoServer(s grpc.ServiceRegistrar, srv ActionTwoServer) {
	s.RegisterService(&ActionTwo_ServiceDesc, srv)
}
...
func _ActionTwo_Call_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/akkaserverless.tck.model.action.ActionTwo/Call",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
// ActionTwo_ServiceDesc is the grpc.ServiceDesc for ActionTwo service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ActionTwo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "akkaserverless.tck.model.action.ActionTwo",
