...
func (c *valueEntityTckModelClient) Process(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/akkaserverless.tck.model.valueentity.ValueEntityTckModel/Process", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterValueEntityTckModelServer(s grpc.ServiceRegistrar, srv ValueEntityTckModelServer) {
	s.RegisterService(&ValueEntityTckModel_ServiceDesc, srv)
}
...
func _ValueEntityTckModel_Process_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/akkaserverless.tck.model.valueentity.ValueEntityTckModel/Process",
	}
...
// ValueEntityTckModel_ServiceDesc is the grpc.ServiceDesc for ValueEntityTckModel service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ValueEntityTckModel_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "akkaserverless.tck.model.valueentity.ValueEntityTckModel",
	...
	Metadata: "valueentity/value_entity.proto",
}
...
func (c *valueEntityTwoClient) Call(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/akkaserverless.tck.model.valueentity.ValueEntityTwo/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ValueEntityTwo_Call_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/akkaserverless.tck.model.valueentity.ValueEntityTwo/Call",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ValueEntityTwo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "akkaserverless.tck.model.valueentity.ValueEntityTwo",
...
func (c *valueEntityConfiguredClient) Call(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/akkaserverless.tck.model.valueentity.ValueEntityConfigured/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterValueEntityConfiguredServer(s grpc.ServiceRegistrar, srv ValueEntityConfiguredServer) {
	s.RegisterService(&ValueEntityConfigured_ServiceDesc, srv)
}
...
func _ValueEntityConfigured_Call_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/akkaserverless.tck.model.valueentity.ValueEntityConfigured/Call",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
// ValueEntityConfigured_ServiceDesc is the grpc.ServiceDesc for ValueEntityConfigured service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ValueEntityConfigured_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "akkaserverless.tck.model.valueentity.ValueEntityConfigured",
